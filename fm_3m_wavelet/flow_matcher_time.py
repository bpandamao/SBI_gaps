...
from residual_wavelet_try01 import create_signal_cf_model
...
class ContinuousFlowMatcherTime(nn.Module):
    def __init__(
        ...
        # Create flow matching model with symmetric kernels
        ...
        self.flow_model = create_signal_cf_model(
            ...
            posterior_kwargs={
                ...
                "hidden_dims": (1024,1024,512,256,128),#old (512,256, 128, 64),
                 # These hidden dimensions are for the network that embeds the parameters (theta)
                "param_hidden_dims": (64,128,256,512),#(64,128,256),(64,128,256,512),
